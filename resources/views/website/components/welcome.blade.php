...
@section('content')
    ...
    <section id="services" class="services section">
        ...
        <div class="container section-title" data-aos="fade-up">
            ...
            <p>Showcase Your Products and Services, Network, Get Partnerships </p>
                ...
                <div class="row g-0">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Shelf Life</h3>
                                <p>
                                    Unlike other media, a magazine remains in circulation for much longer (months and even
                                    years)
                                    in corporate receptions, libraries and resource centers. So it reaches many more readers
                                    in the long run.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Profiles</h3>
                                <p>
                                    The <strong>IMPACTIVE BUBU</strong> Expo Magazine has dedicated space to domestic
                                    investors and other
                                    interested
                                    companies to run their profiles in our profiles section. It will have special focus on
                                    the Buy Uganda Build
                                    Uganda policy
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Website Link</h3>
                                <p>
                                    It will be uploaded on here and on the Ministry of Trade,
                                    Industry and
                                    Cooperatives website <a href="https://www.mtic.go.ug/">Ministry Of Trade</a> so client
                                    adverts and profiles will be viewed by a
                                    GLOBAL BUSINESS
                                    & INVESTMENT AUDIENCE. The public will have access to a free download of the magazine on
                                    <a href="https://www.mtic.go.ug/">here</a>.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Reach</h3>
                                <p>
                                    A guaranteed distribution of over 5,000 copies through the Ministry of Trade, Industry
                                    and Cooperatives MTIC
                                    and other Ministries, Departments and Agencies (MDAs) of Government and directly through
                                    Impactive Digital’
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Readership</h3>
                                <p>
                                    An advert in the IMPACTIVE BUBU Expo Magazine has an assured audience of domestic
                                    investors,
                                    corporate entities, government policy makers, international organizations, donors,
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Media</h3>
                                <p>
                                    Adverts and talk shows will run on various media both electronic and print media for
                                    Three (3) months.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                ...
                                <p>
                                    Campaigns; Influencer partnerships and Hashtag Challenges “My bubudeal” challenge are
                                    being planned for the promotional 3 months
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <div class="service-item-content">
                                <h3 class="service-heading">Road drives</h3>
                                <p>
                                    We will conduct road drives throughout the 5 Divisions and Greater Kampala.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <h2 class="content-title mb-4">
                            <strong>Network, Build Capacity AND get Partnerships</strong>
                        </h2>
                        <p class="opacity-50">
                            Apetize your customers to buy Ugandan products and expand your business reach to potential
                        ...
                        <div class="row my-5">
                            <div class="col-lg-12 d-flex align-items-start mb-4">
                                ...
                                <div>
                                    <h4 class="m-0 h5 text-white">Market Ugandan made Products</h4>
                                    <p class="text-white opacity-50">Increase your product market in Uganda</p>
                                </div>
                            </div>
                            <div class="col-lg-12 d-flex align-items-start mb-4">
                                <i class="bi bi-heart me-4 display-6"></i>
                                <div>
                                    <h4 class="m-0 h5 text-white">Attract Potential business Partners</h4>
                                    <p class="text-white opacity-50">Acquire sponsorships and support to expand your
                                        business</p>
                                </div>
                            </div>
                            <div class="col-lg-12 d-flex align-items-start">
                                ...
                                <div>
                                    <h4 class="m-0 h5 text-white">Put your products to Spotlight</h4>
                                    <p class="text-white opacity-50">Let Ugandans know about your products.</p>
                                </div>
                            </div>
                        </div>
                    </div>
