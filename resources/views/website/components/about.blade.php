    ...
    <main class="main">
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-5 order-lg-1" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p class="mb-4">
                            Are you an enterprise, an innovator, a service provider of Ugandan made products? Let
                            <strong>impactive BUBU Expo 2025</strong> help you attract,
                            and apetize your potential customers in Uganda. We are a platform to market all your goods and
                            services, to help you enhance your network with government Agencies,
                            and this will potentially increase and expand your enterprise.
                        </p>
                        <ul class="list-unstyled list-check">
                            <li>Exhibitions</li>
                            <li>Conferences</li>
                            <li>Awards Dinner Gala</li>
                        </ul>
        ...
        <section id="services" class="services section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>SERVICES</h2>
                <p>The 2025 Impactive Buy Uganda Build uganda (BUBU) Expo shall blend cultural sensitivity and relevance to
                    modernization and promote local products and services by showcasing the following:</p>
                            ...
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 509.435 509.435" style="enable-background: new 0 0 512 512"
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Traditional Sectors:</h3>
                                    <p>
                                        Agriculture and Food Processing, Manufacturing and Industry, Construction industry,
                                        Automobile industry
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 514.314 514.314" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Emerging Sectors:</h3>
                                    <p>
                                        BPO- IT Enabled Services, Health and Wellness, Renewable Energy and
                                        Environment
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 516.53 516.53" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Creative Industries:</h3>
                                    <p>
                                        Arts and Crafts, Tourism and Hospitality industry
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 509.389 509.389" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Education and Skills
                                        Develoment:</h3>
                                    <p>
                                        Education Institutions, Innovation and Entrepreneurship
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 513.089 513.089" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Modified Features:</h3>
                                    <p>
                                        Business-to-Business (B2B) matchmaking, Business conference and Women empowerment
                                        seminar, Awards ceremony for outstanding
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="service-item">
                                ...
                                <div class="service-item-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                        xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80" x="0"
                                        y="0" viewBox="0 0 511.67 511.67" style="enable-background: new 0 0 512 512"
                                        xml:space="preserve" class="">
                                        <g>
                                            <path
                                ...
                                <div class="service-item-content">
                                    <h3 class="service-heading">Financial Sector</h3>
                                    <p>
                                        Commercial Banks, Credit Institutions,
                                        Microfinance Institutions, Development, Funding Institutions, Insurance, Companies,
                                        Investment Institutions,
                                        RuralFinance Institutions, Digital Financial
